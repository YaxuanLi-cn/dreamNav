...
class TourFramePairDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label_norm_heading = torch.tensor(norm_heading, dtype=torch.float32)
...
class AblationNoMatchModel(nn.Module):
    """Ablation: dual-image ConvNeXt with cos/sin heading, but NO match encoder."""
...
def train_one_epoch(train_loader, test_loader, model, optimizer, epoch, device, logger):
    ...
    if metric < best_metric:
        ...
        pred_json_path = 'enhanced_ablation_no_match_seen.json'
...
parser = argparse.ArgumentParser(description='Ablation: remove SuperGlue matches, keep cos/sin heading representation')
...
parser.add_argument('--output_file', type=str, default='test_results_enhanced_ablation_no_match.log')
parser.add_argument('--model_name', type=str, default='convnext_base.fb_in22k_ft_in1k_384')
parser.add_argument('--img_size', type=int, default=384)
parser.add_argument('--batch_size', type=int, default=16)
parser.add_argument('--num_workers', type=int, default=4)
parser.add_argument('--checkpoint', type=str, default='')
parser.add_argument('--save_dir', type=str, default='checkpoints_enhanced_ablation_no_match')
...
def main():
    ...
    logger = logging.getLogger('enhanced_ablation_no_match_train')
    ...
    model = AblationNoMatchModel(model_name=args.model_name, pretrained=True)
