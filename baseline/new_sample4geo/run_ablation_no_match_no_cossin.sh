...
OUTPUT_FILE="test_results_enhanced_ablation_no_match_no_cossin.log"
SAVE_DIR="checkpoints_enhanced_ablation_no_match_no_cossin"

python train_ablation_no_match_no_cossin.py \
