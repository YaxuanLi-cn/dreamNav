...
parser.add_argument('--superglue_output', default='/root/autodl-tmp/dreamnav/superglue_output/', type=str, help='path to superglue match output dir')
...
class TourFrameDataset(Dataset):
    def __init__(self, data_dir, json_dir, model_path='/root/dreamNav/models/dino_resnet', superglue_output='/root/autodl-tmp/dreamnav/superglue_output/'):
        super().__init__()
        ...
        self.match_dir = superglue_output
...
def main():
    ...
    train_dataset = TourFrameDataset(args.data_dir, args.train_path, model_path=args.model_path, superglue_output=args.superglue_output)
    test_dataset = TourFrameDataset(args.data_dir, args.test_path, model_path=args.model_path, superglue_output=args.superglue_output)
